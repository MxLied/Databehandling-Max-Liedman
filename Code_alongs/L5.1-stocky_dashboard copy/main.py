...
app.layout = html.Main(
    [
        ...
        # storing intermediate value on clients browser in order to share between callbacks
        dcc.Store(id = "filtered-df")
    ]
)

@ app.callback(Output("filtered-df", "data", input("stockpicer-dropdown", "value"), input("time-slider", "value")))
...
# df_dict ## en dataframe som är en dict med listor av dataframe